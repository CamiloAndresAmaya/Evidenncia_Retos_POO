...
public class PersonaReto3 {
    ...
    public PersonaReto3(String tipoDoc, String documento, String nombre, String apellido, String sexo, int edad,
    int peso, Double estatura) {
